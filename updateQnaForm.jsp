...
<div id="contents_sub">
    <div class="content_area">
        ...
        <form id="frm" method="post" name="updateform" action="QnaUpdatePro.do">
                    ...
                    <td>
                        <div class="ibox">
                            <select name="qna_type" id="smyeong" type="text" class="i_text" data-check="required"
                                   style="width:100px">
                               		<c:if test="${article.qna_type=='결제문의'}">
                                	...
                                	<c:if test="${article.qna_type=='이용문의'}"> 
                               			<option value="">선택</option> 
                                	...
                                	<c:if test="${article.qna_type=='시설문의'}"> 
                                		<option value="">선택</option> 
	                               		<option value="결제문의">결제문의</option>
		                                <option value="이용문의">이용문의</option>
                               			<option value="시설문의" selected>시설문의</option>
                               			<option value="건의사항">건의사항</option>
                               			<option value="기타">기타</option>
                                	</c:if>
                                	
                                	<c:if test="${article.qna_type=='건의사항'}"> 
                                		<option value="">선택</option> 
	                               		<option value="결제문의">결제문의</option>
		                                <option value="이용문의">이용문의</option>
                               			<option value="시설문의">시설문의</option>
                    ...
                    <td>
                        <div class="ibox">
                            <input name="qna_subject" id="smyeong" type="text" class="i_text" data-check="required"
                                   style="width:400px" placeholder="제목을 입력하세요." value="${article.qna_subject}">
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="2">
                        <div class="ibox">
                            <textarea data-check="required" name="qna_content" id="jm" style="width:98%; height:350px;"
                                      placeholder="문의 내용을 입력하세요." class="i_area">${article.qna_content}</textarea>
                        </div>
                    </td>
                </tr>
                </tbody>
