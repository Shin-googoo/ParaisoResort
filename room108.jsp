            ...
            <div class="info_cont_box">
                ...
                <div class="con_box_guide">
                    ...
                    <div class="con_box_tbox">
                        ...
                        <p class="con_box_txt"><span style="font-size: medium;">&middot; 투숙 정원 외 인원 추가 시 중학생&nbsp;이상 부터&nbsp;1박당 11,000원 별도 요금이 부과됩니다.</span>
                        </p>
                        <p class="con_box_txt"><span style="font-size: medium;">&middot; 침구 추가 요청 시 투숙기간 내 1회 22,000원 별도 요금이 부과됩니다. (침구 교체 시 추가비용 발생)</span>
                        </p>
                        <p class="con_box_txt"><span style="font-size: medium;">&middot; 입실시간 15시, 퇴실시간 11시입니다.</span>
                        </p>
                        <p class="con_box_txt"><span style="font-size: medium;">&middot; 오후 10시 이후의 입실은 사전에 반드시 연락을 주시기 바랍니다.</span>
                        </p>
                        <p class="con_box_txt"><span style="font-size: medium;">&middot; Late C/O ~ 오후 3시, 1박 기준 50% 요금 발생, 오후 3시 이후 퇴실시에는 1일 추가 요금 적용</span>
                        </p>
                        <p class="con_box_txt"><span style="font-size: medium;">&middot; 반려동물과 동반입실은 불가합니다.(당일 취소와 동일하게 적용 됨)</span>
                        </p>
                        <p class="con_box_txt"><span style="font-size: medium;">&middot;&nbsp;호텔 내 객실을 포함한 모든 공간은 금연이며, 지정된 외부 공간에서만 흡연이 가능합니다.</span>
                        </p>
                        <p class="con_box_txt"><span style="font-size: medium;">&middot; 전 객실 조리가 불가합니다.</span></p>
                        <p class="con_box_txt"><span style="font-size: medium;">&middot; 객실의 모든 시설물은 이용중 훼손 시 이용객측에 변상하게 됩니다.</span>
                        </p>
                        <p class="con_box_txt"><span style="font-size: medium;">&middot; 이용객 본인 부주의에 의한 안전사고는 이용객 본인이 책임지게 됩니다.</span>
                        </p>
                        <p class="con_box_txt"><span style="font-size: medium;">&middot; 예약전화 : 064) 805-0115</span></p>
                    </div>
                </div>
            </div>
        </div>
