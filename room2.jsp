	...
	<!-- 슬라이드 사용 여부 / 환경설정에서 수정가능 -->
		<div class="sub_slide_area">
			...
			<div class="sub_slide_big">
				<img src="./image/room2_big1.jpg" alt="이미지슬라이드큰이미지" id="sub_slider_big_pic" />
			</div>
			...
			<div class="s_slider_grp">
				...
				<ul class="sub_slide_small" style="overflow: hidden;">				
						<li class="active" id="small_slide_1">
							<img src="./image/room2_small1.jpg" alt="이미지슬라이드작은이미지">						 
							<span class="hover_bg"></span>
						</li>
					
						<li id="small_slide_2">
							<img src="./image/room2_small2.jpg" alt="이미지슬라이드작은이미지"> 							 
							<span class="hover_bg"></span>
						</li>
					
						<li id="small_slide_3">
							<img src="./image/room2_small3.jpg" alt="이미지슬라이드작은이미지"> 	 
							<span class="hover_bg"></span>
						</li>
					
						<li id="small_slide_4">
							<img src="./image/room2_small4.jpg" alt="이미지슬라이드작은이미지">  
							<span class="hover_bg"></span>
						</li>					
				</ul>
			</div>
...
<h2 class="info_cont_title">패밀리룸</h2>
<p class="info_cont_txt">영유아 자녀를 동반한 가족이 편안하게 휴식 할 수 있는 패밀리 객실</p>
</div>
</div>
<p>&nbsp;&nbsp;</p>
...
<td class="info_ntb_td">400,000원</td>
</tr>
</tbody>
</table>
</div>
...
<script src="./js/room2.js?ver=1"></script>
