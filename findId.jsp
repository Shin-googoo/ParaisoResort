   ...
   <script src="https://code.jquery.com/jquery-3.6.0.js"></script>
    ...
    $(function(){
        ...
        $(".findForm").submit(function(){
            ...
            var judge1 = CheckName.call(document.querySelector("input[name=mem_name]"));
            var judge2 = CheckEmail.call(document.querySelector("input[name=mem_email]"));
...
<div class="sub_topgrp">
    <div class="subtitbox">
        <h1 id="title">아이디 찾기</h1><!-- 타이틀 -->
    </div>
    <div class="s_topimg">
        <img src="./image/room_top.png"/>
    </div>
</div>
<form class="findForm" name="findForm" action="emailsendid.do" method="post">
    <div class="info-container">
    <!-- 	<div class="percent"></div> --><!-- 퍼센트바 -->
        	<h2 class="info_cont_title center">아이디를 잊으셨나요?</h2>
        	<p class="info_cont_text center">가입 시 입력한 정보를 입력해주세요. 회원님의 아이디가 이메일로 전송됩니다.</p>
         <div class="page">
        	<img class="img_bar" src="./image/idimg.png">
        	<div class="box">
        		<div class="input-box">
         ...
         <div class="page">
        	<img class="img_bar" src="./image/idimg2.png">
        	<div class="box">
        		<div class="input-box">
